...
class SDNE(object):
    def __init__(self, graph, encoder_layer_list=64, alpha=1e-6, beta=5., nu1=1e-5, nu2=1e-4,
                 batch_size=16, epoch=50, learning_rate=0.9):
        """
...
class SDNE2(object):
    def __init__(self, graph, encoder_layer_list=64, alpha=1e-6, beta=5., nu1=1e-5, nu2=1e-5,
                 batch_size=4, max_iter=80, learning_rate=None):
